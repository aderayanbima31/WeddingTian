...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!--
		...
		<div class="container">
	        ...
	        <div class="navbar-header">
				...
				<a href="#" class="js-qbootstrap-nav-toggle qbootstrap-nav-toggle" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar"><i></i></a>
	          	<a class="navbar-brand" href="<?php echo base_url('index.php');?>">Wedding</a>
	        </div>
					...
					<div class="container">
						<div class="col-md-10 col-md-offset-1">
							<div class="animate-box svg-sm colored">
								<img src="<?php echo base_url('assets/images/flaticon/svg/004-nature.svg');?>" class="svg" alt="Free HTML5 Bootstrap Template by QBootstrap.com">
			...
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="col-md-5 col-sm-5 col-xs-5 nopadding">
						<img src="<?php echo base_url('assets/images/groom.jpg');?>" class="img-responsive" alt="Free HTML5 Bootstrap Template by QBootstrap.com">
						<h3>Louie Jie L. Mahusay</h3>
						<span>Groom</span>
					</div>
					<div class="col-md-2 col-sm-2 col-xs-2 nopadding"><h2 class="amp-center"><img src="<?php echo base_url('assets/images/flaticon/svg/003-luxury.svg');?>" class="svg img-responsive" alt="Free HTML5 Bootstrap Template by QBootstrap.com"></h2></div>
					<div class="col-md-5 col-sm-5 col-xs-5 nopadding">
						<img src="<?php echo base_url('assets/images/bride.jpg');?>" class="img-responsive" alt="Free HTML5 Bootstrap Template by QBootstrap.com">
	...
	<div id="qbootstrap-countdown" data-stellar-background-ratio="0.5" style="background-image: url(<?php echo base_url('assets/images/cover_bg_2.jpg');?>" data-section="wedding-day">
		<div class="overlay"></div>
		<div class="display-over">
			<div class="container">
				<div class="row animate-box">
					<div class="col-md-12 section-heading text-center svg-sm colored">
						<img src="<?php echo base_url('assets/images/flaticon/svg/006-flower-bell-outline-design-variant-with-vines-and-leaves.svg');?>" class="svg" alt="Free HTML5 Bootstrap Template by QBootstrap.com">
	...
	<footer id="footer" role="contentinfo">
		<div class="container">
			<div class="row row-bottom-padded-sm">
				<div class="col-md-12">
					<p class="copyright text-center">&copy; 2017 <a href="<?php echo base_url('index.php');?>">Wedding</a>. All Rights Reserved. Images by <a href="http://unsplash.com/" target="_blank">Unsplash</a></p>
				</div>
			</div>
			<div class="row">
